...
resource "restapi_object" "take_snapshot" {
  ...
  data = "{\"indices\": \"index_1,index_2,index_3,index_4\",\"ignore_unavailable\": false,\"include_global_state\": false,\"metadata\": {\"taken_by\": \"elastic\",\"taken_because\": \"backup before upgrading\"}}"
}
